...
const options: ApexOptions = {
  ...
  subtitle: {
    text: "Categoria dos eventos detectados",
    align: "center",
    style: {
      fontSize: "14px",
    },
  ...
  labels: ["Customizado", "Protocolo", "Signature"],
  colors: ["#FFF", "#FFFFFFAA", "#FFFFFF70"],
  legend: {
    position: "bottom",
  },
...
const series = ref([
  data?.value.alertTypeIndicators.custom,
  data?.value.alertTypeIndicators.protocol,
  data?.value.alertTypeIndicators.signature,
]);
</script>
