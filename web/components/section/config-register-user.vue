...
<template>
  <transition name="scroll-x">
    <div
      v-show="tabSelected === 'register-user'"
    ...
    >
      ...
      <div class="max-w-lg mx-auto space-y-3">
        <div
          ...
          class="bg-red-500 text-white p-2 flex gap-2 items-center rounded"
        >
          <Icon name="uil:exclamation-triangle" class="size-5" />
        ...
        <form @submit.prevent="onSubmit" class="space-y-4">
          ...
          <div class="flex gap-4 justify-center mt-4">
            <button
              ...
              class="bg-brand border !border-brand w-full px-5 py-2.5 text-white font-medium rounded-md transition-all hover:bg-brand-hover outline-none focus:outline-none disabled:opacity-40 disabled:pointer-events-none"
            >
